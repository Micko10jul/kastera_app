...
class RiwayatPemasukanPage extends StatefulWidget {
  const RiwayatPemasukanPage({super.key});

  @override
  State<RiwayatPemasukanPage> createState() => _RiwayatPemasukanPageState();
}

class _RiwayatPemasukanPageState extends State<RiwayatPemasukanPage> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      debugPrint("Error fetch pemasukan: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Riwayat Pemasukan', style: TextStyle(color: Color(0xFF1E392A), fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(_formatRp(_totalPemasukan), style: const TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
              Expanded(
                child: _transaksi.isEmpty 
                  ? const Center(child: Text("Belum ada data pemasukan di rentang ini", style: TextStyle(color: Colors.grey)))
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.arrow_downward, color: Color(0xFF4A6541)),
                              ...
                              Text('+ ${_formatRp((tx['jumlah_nominal'] as num).toDouble())}', style: const TextStyle(color: Color(0xFF4A6541), fontWeight: FontWeight.bold)),
